...
if __name__ == '__main__':
    ...
    suite.addTest(GetEventListTest('test_get_event_list_auth_null'))
    suite.addTest(GetEventListTest('test_get_event_list_auth_error'))
    suite.addTest(GetEventListTest('test_get_event_list_eid_null'))
    suite.addTest(GetEventListTest('test_get_event_list_eid_success'))
